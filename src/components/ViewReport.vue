    ...
    <div class="card-responsive">
      <div class="card-wrapper">
        <div class="card-title">
          ...
          <div class="row">
            <div class="col-sm-6">
              <h2><icon class="fa-solid fa-file-lines"/>&nbsp;&nbsp;{{ form.eventTitle }}</h2>
            </div>
            <div class="col-sm-6">
                <a>
              ...
              <h1></h1>
                  ...
                  <div class="col-md-5 mb-2 pb-2">
                    <div>
                      ...
                      <el-input type="textarea" readonly size="large" v-model="form.eventDetails" style="color:black; font-size:17px;padding-bottom:25px" disabled/>
                    </div>
                  </div>
